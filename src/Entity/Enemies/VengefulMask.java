...
public class VengefulMask extends Enemy {
	...
	public VengefulMask (TileMap tm, Player p, ArrayList<EnemyProjectile> eProjectiles) {
	...
	public void update() {
		...
		if(shooting && !charging) {
			...
			if(animation.getFrame() == 5 && animation.getCount() == 0) {
				...
				CursedFireball cf = new CursedFireball(tileMap, 1);
				cf.setPosition(x, y);
